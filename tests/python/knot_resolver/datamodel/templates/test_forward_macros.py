...
{{ policy_rule_forward_add(rule.subtree[0],rule.options,rule.servers) }}"""
    ...
    result = "policy.rule_forward_add('.',{dnssec=true,auth=false},{{'2001:148f:fffe::1',tls=false,quic=false,hostname='odvr.nic.cz',},{'185.43.135.1',tls=false,quic=false,hostname='odvr.nic.cz',},})"
