...
from knot_resolver.utils.data_modeling import ModelNode
from knot_resolver.utils.data_modeling.types.base_types import BaseType
from knot_resolver.utils.data_modeling.types.inspect import (
    NoneType,
    is_dict,
    is_list,
    is_literal,
