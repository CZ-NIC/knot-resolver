...
from knot_resolver.utils.data_modeling.types.base_generic_types import ListOrItem
from knot_resolver.utils.data_modeling.types.inspect import get_base_generic_type_wrapper_argument
