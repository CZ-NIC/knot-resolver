...
from knot_resolver.utils.modeling.types.base_generic_custom_types import BaseGenericCustomTypeWrapper
...
def is_base_custom_type(typ: Any) -> bool:
    origin = get_origin(typ)
    return inspect.isclass(origin) and issubclass(origin, BaseCustomType)
