...
class MetricsCommand(Command):
    ...
    def register_args_subparser(
        ...
        metrics = subparser.add_parser(
            "metrics",
            help="Get aggregated metrics from the running resolver in JSON format"
            " (default) or optionally in Prometheus format."
            "\nThe 'prometheus-client' Python package needs to be installed"
            " if you wish to use the Prometheus format."
