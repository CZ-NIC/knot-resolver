...
local function check_time()
	...
	if jump_backward > mod.threshold then
		log_info(ffi.C.DETECTTIMEJUMP, "Detected backwards time jump, clearing cache.\n" ..
	...
	elseif -jump_backward > mod.threshold then
		...
		log_info(ffi.C.DETECTTIMEJUMP, "Detected forward time jump.  (Suspend-resume, possibly.)")
