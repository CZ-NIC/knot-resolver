-- makes sure this module runs just once
...
-- TODO kontrola verze, aby to vybouchlo kdyz je spatna verze sysrepa
...
--- Table for converting sr_data_t union type to string based on the provided type
