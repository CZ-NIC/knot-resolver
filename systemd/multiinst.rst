...
.. warning:: This section describes the usage of kresd when running under systemd
   without Manager.  Please try to avoid this style from v6.0.0 onwards,
   as the support and docs will be very limited.
